...
public class FlamePillar extends FirearmsAbstractCards {
    public static final String ID = SharpshooterMod.makeID(FlamePillar.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String IMG_PATH = SharpshooterMod.makeCardPath("FlamePillar.png");
        ...
        if (!AbstractDungeon.getMonsters().areMonstersBasicallyDead()) {
            ...
            while (it.hasNext()) {
                ...
                if (!monster.isDead && !monster.isDying) {
                    addToBot(new ApplyPowerAction(monster,p,new WeakPower(monster,1,true),1));
                }
            }
        }
    }
