...
import Sharpshooter.powers.FlashPower;
...
public class PlasmaBooster extends FirearmsAbstractCards {
    public static final String ID = SharpshooterMod.makeID(PlasmaBooster.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String IMG_PATH = SharpshooterMod.makeCardPath("PlasmaBooster.png");
        ...
        if (!AbstractDungeon.getMonsters().areMonstersBasicallyDead()) {
            ...
            while (it.hasNext()) {
                ...
                if (!monster.isDead && !monster.isDying) {
                    addToBot(new ApplyPowerAction(monster,p,new FlashPower(monster,1),1));
                }
            }
        }
    }
