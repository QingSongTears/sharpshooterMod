...
public class MagazineDrum extends BulletAbstractCards {
    public static final String ID = SharpshooterMod.makeID(MagazineDrum.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String IMG_PATH = SharpshooterMod.makeCardPath("MagazineDrum.png");
